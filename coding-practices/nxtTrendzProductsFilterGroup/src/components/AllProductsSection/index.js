...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&category=${activeCategory}&title_search=${searchInput.trim()}&rating=${activeRating}`
    const options = {
      headers: {
  ...
  render() {
    const {activeCategory, activeRating, searchInput} = this.state
