...
class Events extends Component {
  state = {selectedEventStatus: 'INITIAL'}

  onEventSelected = id => {
    const selectedEvent = eventsList.find(eachEvent => eachEvent.id === id)
    this.setState({selectedEventStatus: selectedEvent.registrationStatus})
  }
    ...
    return (
      <div className="bg-container">
        ...
        <div className="event-register-container">
          <ActiveEventRegistrationDetails eventStatus={selectedEventStatus} />
        </div>
      </div>
    )
  }
