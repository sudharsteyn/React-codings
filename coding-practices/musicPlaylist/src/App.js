...
class App extends Component {
  ...
  searchTracksList = (tracksList, searchInput) => {
  ...
  renderNoSongsFound = () => (
    <NoSongsFoundContainer>
      <NoSongFoundHeading>No Songs Found</NoSongFoundHeading>
    </NoSongsFoundContainer>
  )

  renderTracksList = filteredTracksList => (
    <>
  ...
  render() {
    ...
    const filteredTracksList = this.searchTracksList(tracksList, searchInput)
    return (
      <MainContainer>
        <SingerContainer>
          ...
          <PlaylistAndSearch>
            ...
            <SearchContainer>
              ...
              <SearchButton type="button">
                <BiSearch color="#cbd5e1" size={16} />
              </SearchButton>
            </SearchContainer>
          </PlaylistAndSearch>
          <SongItemsList>
            {filteredTracksList.length > 0
              ? this.renderTracksList(filteredTracksList)
