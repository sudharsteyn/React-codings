...
class App extends Component {
  ...
  addCartItem = product => {
    ...
    const {cartList} = this.state
    const findProduct = cartList.find(eachCart => eachCart.id === product.id)
    ...
    return (
      <CartContext.Provider
        value={{
          ...
          incrementCartItemQuantity: this.incrementQuantityItem,
          decrementCartItemQuantity: this.decrementQuantityItem,
        }}
      >
        <Switch>
